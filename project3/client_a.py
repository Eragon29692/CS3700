...
if __name__ == '__main__':
   ...
   '\x02\x00\x01\x75\x97\x52' #src addres...
    ...
    '\x45' #header length
    '\x00'
    '\x00\x3a' #total length
    '\x00\x03' #identification
    '\x00\x00'  #offset
    '\xff' #time to live
    '\x06' #protocole
    '\xa7\xb3' #header checksum
    '\x0a\xAF\x61\x34'#ip of src...
    '\x0a\x00\x00\x01'#ip of dest...
    
    '\xa9\x26' #source port
    '\x00\x50' #dest port
    '\x00\x04\xab\x55' #seq number
    '\x23\xb3\x88\xbe' #ack number
    '\x50' 
    '\x10'
    '\x05\x78' #window size
    '\xb6\x61' #checksum
    '\x00\x00' #urgent pointer
    '\x47\x45\x54\x20\x2f\x20\x48\x54\x54\x50\x2f\x31\x2e\x30\x0d\x0a\x0d\x0a' # HTTP Request method
    )
